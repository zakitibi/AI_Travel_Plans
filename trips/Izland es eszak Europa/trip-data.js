  ...
  sections: {
    baltikum: {
      ...
      mapStops: [
        ...
        { name: "Keresztek Hegye", kind: "church", lat: 56.0158, lng: 23.4168, day: 3, date: "2026-07-12", detail: "Több százezer kereszttel borított zarándokdomb Šiauliai mellett — Litvánia egyik legmegrendítőbb helye.", reviewNote: "Ingyenes, kis parkoló a 12-es út mellett, 5 perc séta. Útba esik Vilnius és Riga között." },
      ...
      days: [
        ...
        },
        {
          ...
          activities: [
            ...
            { time: "16:00", icon: "🏖", name: "Pärnu — tengerparti megálló (ebéd + séta)", mapName: "Pärnu", googleRating: "4.5", maps: "https://www.google.com/maps/search/?api=1&query=P%C3%A4rnu+Beach+Estonia", duration: "~1 óra", detail: "Észtország nyári fővárosa: homokos strand, fapados villák, a Rüütli sétálóutca kávézói. Jó kiszállós pont a hosszú etap közepén. Google ★4.5. 🅿 A Pärnu Beach (Ranna puiestee) melletti parkolókban a strandnál (nyáron gyorsan telik — korábban jobb), vagy a Rüütli / óváros környéki fizetős utcai parkolókban." },
            { time: "20:00", icon: "⚓", name: "Tallinn — Rotermann / Sadama negyed szállás", maps: "https://www.google.com/maps/search/?api=1&query=Rotermann+Quarter+Tallinn", detail: "Tallinnban a Rotermann / Sadama negyed a legjobb autós bázis: közel a kompterminálhoz és az óvároshoz. 🅿 Az óvárosba NE hajts be (szűk, drága, kevés hely) — a Rotermann parkolóház (Roseni 10) vagy a T1 Mall parkolója a legpraktikusabb, onnan gyalog az óváros. A júl. 16-i reggeli Tallink miatt is a kikötő-közeli lokáció a nyerő." }
          ],
          notes: ["🅿 Autós logisztika a Gauja-völgyben: a Turaida Múzeumrezervátum parkolója (Turaidas iela 10) a legjobb központi bázis a Turaida-oldalhoz (vár + barlang + park), a Gauja túlpartján pedig Sigulda a vár-komplexum parkolójából (Pils iela 16) járható be. A két oldal közt ~10 perc autóval a szerpentinen.", "Turaida Castle: jobb kilátás és kevesebb tömeg, mint a siguldai romok — ha csak egyet néztek, ez legyen.", "Gutmanis-barlang: a Turaida kastélyból gyalog is elérhető (erdei ösvény, ~15 perc lefelé), de autóval a P8 menti kis parkoló gyorsabb.", "🏰 Cēsis (opcionális, ★4.6): ~30 km-re Sigulda mögött hangulatos középkori városka a Livóniai Rend várromjával (lámpással vezetett túra) — szép kiegészítés, ha korán végeztek a Gauja-hármassal, de ~1,5 óra extra oda-vissza.", "Pärnu: ha a Gauja tele volt programmal, csak gyors kávé/láb-kinyújtás; ha maradt idő, fél óra a strandon jó.", "Tallinn: autóval az óvárosba ne menj be — Rotermann parkolóház / T1 Mall, onnan gyalog."]
        },
        {
          num: "6",
      ...
      days: [
        {
          ...
          activities: [
            { time: "07:35", icon: "✈", name: "Icelandair FI306 — KEF → ARN", detail: "Reykjavík/Keflavík → Stockholm/Arlanda, 07:35 → 12:45. Érkezés után <strong>transzfer az ARN Långtidsparkering telephelyre</strong> (Elkraftsgatan 7) az autóért (foglalás #127891, a parkolás pont ma jár le) — innen <strong>behajtás Stockholmba</strong>, az autó a szállásnál / belvárosi P-házban parkol a városnapok alatt. Napközben a városban tömegközlekedés vagy séta a hatékonyabb." },
