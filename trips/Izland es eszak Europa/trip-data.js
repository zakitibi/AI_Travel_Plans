    ...
    izland2: {
      ...
      days: [
        ...
        },
        {
          ...
          mapColor: "#f87171",
          driveLog: { km: "~365 km", stops: 10, driveTime: "~5,5 óra", depart: "08:00", arrive: "~18:30", timelinePoints: [{time:"08:00", label:"Hof ind. (déli part)"}, {time:"08:45", label:"Djúpalónssandur"}, {time:"10:30", label:"Arnarstapi"}, {time:"12:00", label:"Gerðuberg"}, {time:"15:00", label:"KEF – vendég leadása"}, {time:"16:15", label:"Reykjanes"}, {time:"17:00", label:"Efrahóp (Grindavík)"}, {time:"17:30", label:"Seltún (Krýsuvík)"}, {time:"18:30", label:"Nupan (Keflavík)"}] },
          character: "Könnyített záró kör a »kis Izland«-on: Djúpalónssandur fekete strand, Lóndrangar bazalttornyok és Arnarstapi sziklaszínpada — a fekete Búðakirkja templomot már TEGNAP ESTE megnéztétek a szállás előtt, így az mára kimarad (Saxhóll, Rauðfeldsgjá és Ytri-Tunga szintén). FONTOS: a félszigetről EGYENESEN a reptérre megyünk, mert a vendég utast 17:00-ra le kell adni a KEF-en (Reykjavík ezért kimarad). 08:00-s indulással, kevesebb megállóval ez kényelmes. A leadás után Tibi + Henni még megnézi a Reykjanes-pontokat (Brimketill, Gunnuhver, Bridge Between Continents, az Efrahóp friss lávamező Grindavíknál), a nap zárásaként a Seltún geotermikus mezőt Krýsuvíknál, majd a reptér melletti Nupan Deluxe az utolsó éjszakára.",
          tags: [
            { label: "Snæfellsnes", cls: "tag-focus" },
